...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Nickname', 'Name', 'Email', 'Password', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nickname', 'name', 'email', 'password', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NICKNAME, self::NAME, self::EMAIL, self::PASSWORD, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'nickname', 'name', 'email', 'password', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nickname' => 1, 'Name' => 2, 'Email' => 3, 'Password' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nickname' => 1, 'name' => 2, 'email' => 3, 'password' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NICKNAME => 1, self::NAME => 2, self::EMAIL => 3, self::PASSWORD => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nickname' => 1, 'name' => 2, 'email' => 3, 'password' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
