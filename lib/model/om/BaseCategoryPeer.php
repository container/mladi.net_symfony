...
abstract class BaseCategoryPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Naslov', 'Text', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'naslov', 'text', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NASLOV, self::TEXT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'naslov', 'text', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Naslov' => 1, 'Text' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'naslov' => 1, 'text' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NASLOV => 1, self::TEXT => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'naslov' => 1, 'text' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CategoryPeer::NASLOV);

		$criteria->addSelectColumn(CategoryPeer::TEXT);
    ...
    foreach (sfMixer::getCallables('BaseCategoryPeer:doCount:doCount') as $callable)
    {
